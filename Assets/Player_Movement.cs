...
public class Player_Movement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //isGrounded = Physics2D.Linecast(groundCaster.position, groundChecker.position, 1 << LayerMask.NameToLayer("Floor"));
        isGrounded = Physics2D.OverlapCircle(groundCaster.position, .12f, 1 << LayerMask.NameToLayer("Floor"));
